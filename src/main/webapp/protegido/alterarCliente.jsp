    ...
    <body>
        <div class="container-fluid row mt-5 justify-content-around">
            <div class="col-7 mt-4">
                <h2 class=" display-5 font-italic text-white">Editar cliente: ${cliente.nome_cliente}</h2>
            </div>
        </div>
        <form class="container-fluid mt-5" action="<c:url value="/AlterarCliente"/>" method="POST">
            <div class="form-group row justify-content-center">
                ...
                <div class="row col-6 justify-content-around">
                    ...
                    <input name="rg" value="${cliente.rg}" class="form-control-lg col-8" type="number" required="true">
                </div>
                <br>
                ...
                <div class="row col-10 justify-content-around">
                    <label class="col-2 align-self-center font-italic h4 text-white">Telefone</label>
            ...
            <div class="form-group row justify-content-around">
                <div class="row col-6 justify-content-between">
                    <label class="col-1 align-self-center font-italic h4 text-white">Endereço</label>
                ...
                <div class="row col-3 justify-content-around">
                    <label class="col-1 align-self-center font-italic h4 text-white">Estado</label>
